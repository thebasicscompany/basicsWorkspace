...
const logger = { info: (...args: any[]) => console.log('[google_tasks-task-lists]', ...args), warn: (...args: any[]) => console.warn('[google_tasks-task-lists]', ...args), error: (...args: any[]) => console.error('[google_tasks-task-lists]', ...args) }
