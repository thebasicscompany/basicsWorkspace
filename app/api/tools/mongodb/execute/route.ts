...
const logger = { info: (...args: any[]) => console.log('[MongoDBExecuteAPI]', ...args), warn: (...args: any[]) => console.warn('[MongoDBExecuteAPI]', ...args), error: (...args: any[]) => console.error('[MongoDBExecuteAPI]', ...args) }
