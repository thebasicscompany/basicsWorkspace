...
const logger = { info: (...args: any[]) => console.log('[MongoDBDeleteAPI]', ...args), warn: (...args: any[]) => console.warn('[MongoDBDeleteAPI]', ...args), error: (...args: any[]) => console.error('[MongoDBDeleteAPI]', ...args) }
