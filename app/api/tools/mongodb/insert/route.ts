...
const logger = { info: (...args: any[]) => console.log('[MongoDBInsertAPI]', ...args), warn: (...args: any[]) => console.warn('[MongoDBInsertAPI]', ...args), error: (...args: any[]) => console.error('[MongoDBInsertAPI]', ...args) }
