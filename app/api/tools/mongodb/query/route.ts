...
const logger = { info: (...args: any[]) => console.log('[MongoDBQueryAPI]', ...args), warn: (...args: any[]) => console.warn('[MongoDBQueryAPI]', ...args), error: (...args: any[]) => console.error('[MongoDBQueryAPI]', ...args) }
