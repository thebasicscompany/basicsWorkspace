...
const logger = { info: (...args: any[]) => console.log('[MongoDBUpdateAPI]', ...args), warn: (...args: any[]) => console.warn('[MongoDBUpdateAPI]', ...args), error: (...args: any[]) => console.error('[MongoDBUpdateAPI]', ...args) }
