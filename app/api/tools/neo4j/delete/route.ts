...
const logger = { info: (...args: any[]) => console.log('[Neo4jDeleteAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jDeleteAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jDeleteAPI]', ...args) }
