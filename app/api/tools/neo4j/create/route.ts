...
const logger = { info: (...args: any[]) => console.log('[Neo4jCreateAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jCreateAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jCreateAPI]', ...args) }
