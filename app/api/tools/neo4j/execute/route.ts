...
const logger = { info: (...args: any[]) => console.log('[Neo4jExecuteAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jExecuteAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jExecuteAPI]', ...args) }
