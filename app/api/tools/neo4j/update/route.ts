...
const logger = { info: (...args: any[]) => console.log('[Neo4jUpdateAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jUpdateAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jUpdateAPI]', ...args) }
