...
const logger = { info: (...args: any[]) => console.log('[Neo4jIntrospectAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jIntrospectAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jIntrospectAPI]', ...args) }
