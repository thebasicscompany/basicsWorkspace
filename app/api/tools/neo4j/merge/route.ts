...
const logger = { info: (...args: any[]) => console.log('[Neo4jMergeAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jMergeAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jMergeAPI]', ...args) }
