...
const logger = { info: (...args: any[]) => console.log('[Neo4jQueryAPI]', ...args), warn: (...args: any[]) => console.warn('[Neo4jQueryAPI]', ...args), error: (...args: any[]) => console.error('[Neo4jQueryAPI]', ...args) }
