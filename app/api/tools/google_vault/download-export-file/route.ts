...
import { enhanceGoogleVaultError } from '@/lib/sim/tools/google_vault/utils'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[google_vault-download-export-file]', ...args), warn: (...args: any[]) => console.warn('[google_vault-download-export-file]', ...args), error: (...args: any[]) => console.error('[google_vault-download-export-file]', ...args) }
