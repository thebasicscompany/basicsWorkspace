...
import { convertMarkdownToHTML } from '@/lib/sim/tools/telegram/utils'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[telegram-send-document]', ...args), warn: (...args: any[]) => console.warn('[telegram-send-document]', ...args), error: (...args: any[]) => console.error('[telegram-send-document]', ...args) }
