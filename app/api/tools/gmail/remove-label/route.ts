...
const logger = {
  info: (...args: any[]) => console.log('[GmailRemoveLabelAPI]', ...args),
  warn: (...args: any[]) => console.warn('[GmailRemoveLabelAPI]', ...args),
  error: (...args: any[]) => console.error('[GmailRemoveLabelAPI]', ...args),
}
