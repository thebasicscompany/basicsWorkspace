...
const logger = {
  info: (...args: any[]) => console.log('[GmailMarkUnreadAPI]', ...args),
  warn: (...args: any[]) => console.warn('[GmailMarkUnreadAPI]', ...args),
  error: (...args: any[]) => console.error('[GmailMarkUnreadAPI]', ...args),
}
