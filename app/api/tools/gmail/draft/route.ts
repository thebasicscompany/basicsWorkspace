...
} from '@/lib/sim/tools/gmail/utils'

export const dynamic = 'force-dynamic'

const logger = {
  info: (...args: any[]) => console.log('[GmailDraftAPI]', ...args),
  warn: (...args: any[]) => console.warn('[GmailDraftAPI]', ...args),
  error: (...args: any[]) => console.error('[GmailDraftAPI]', ...args),
}
