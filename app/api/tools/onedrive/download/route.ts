...
const logger = { info: (...args: any[]) => console.log('[onedrive-download]', ...args), warn: (...args: any[]) => console.warn('[onedrive-download]', ...args), error: (...args: any[]) => console.error('[onedrive-download]', ...args) }
