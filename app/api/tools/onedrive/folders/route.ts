...
const logger = { info: (...args: any[]) => console.log('[onedrive-folders]', ...args), warn: (...args: any[]) => console.warn('[onedrive-folders]', ...args), error: (...args: any[]) => console.error('[onedrive-folders]', ...args) }
