...
const logger = { info: (...args: any[]) => console.log('[onedrive-files]', ...args), warn: (...args: any[]) => console.warn('[onedrive-files]', ...args), error: (...args: any[]) => console.error('[onedrive-files]', ...args) }
