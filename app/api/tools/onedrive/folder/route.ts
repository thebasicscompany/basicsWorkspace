...
const logger = { info: (...args: any[]) => console.log('[onedrive-folder]', ...args), warn: (...args: any[]) => console.warn('[onedrive-folder]', ...args), error: (...args: any[]) => console.error('[onedrive-folder]', ...args) }
