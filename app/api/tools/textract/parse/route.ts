...
const logger = { info: (...args: any[]) => console.log('[textract-parse]', ...args), warn: (...args: any[]) => console.warn('[textract-parse]', ...args), error: (...args: any[]) => console.error('[textract-parse]', ...args) }
