...
const logger = { info: (...args: any[]) => console.log('[reducto-parse]', ...args), warn: (...args: any[]) => console.warn('[reducto-parse]', ...args), error: (...args: any[]) => console.error('[reducto-parse]', ...args) }
