...
const logger = { info: (...args: any[]) => console.log('[wealthbox-items]', ...args), warn: (...args: any[]) => console.warn('[wealthbox-items]', ...args), error: (...args: any[]) => console.error('[wealthbox-items]', ...args) }
