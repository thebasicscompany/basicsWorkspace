...
const logger = { info: (...args: any[]) => console.log('[wealthbox-item]', ...args), warn: (...args: any[]) => console.warn('[wealthbox-item]', ...args), error: (...args: any[]) => console.error('[wealthbox-item]', ...args) }
