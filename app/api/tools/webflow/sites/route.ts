...
const logger = { info: (...args: any[]) => console.log('[webflow-sites]', ...args), warn: (...args: any[]) => console.warn('[webflow-sites]', ...args), error: (...args: any[]) => console.error('[webflow-sites]', ...args) }
