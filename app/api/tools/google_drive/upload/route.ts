...
const logger = {
  info: (...args: any[]) => console.log('[GoogleDriveUploadAPI]', ...args),
  warn: (...args: any[]) => console.warn('[GoogleDriveUploadAPI]', ...args),
  error: (...args: any[]) => console.error('[GoogleDriveUploadAPI]', ...args),
}
