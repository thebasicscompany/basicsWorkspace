...
const logger = { info: (...args: any[]) => console.log('[imap-mailboxes]', ...args), warn: (...args: any[]) => console.warn('[imap-mailboxes]', ...args), error: (...args: any[]) => console.error('[imap-mailboxes]', ...args) }
