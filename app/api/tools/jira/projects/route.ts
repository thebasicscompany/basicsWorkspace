...
const logger = { info: (...args: any[]) => console.log('[jira-projects]', ...args), warn: (...args: any[]) => console.warn('[jira-projects]', ...args), error: (...args: any[]) => console.error('[jira-projects]', ...args) }
