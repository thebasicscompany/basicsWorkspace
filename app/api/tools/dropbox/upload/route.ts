...
const logger = { info: (...args: any[]) => console.log('[dropbox-upload]', ...args), warn: (...args: any[]) => console.warn('[dropbox-upload]', ...args), error: (...args: any[]) => console.error('[dropbox-upload]', ...args) }
