...
const logger = { info: (...args: any[]) => console.log('[zoom-get-recordings]', ...args), warn: (...args: any[]) => console.warn('[zoom-get-recordings]', ...args), error: (...args: any[]) => console.error('[zoom-get-recordings]', ...args) }
