...
const logger = { info: (...args: any[]) => console.log('[zoom-meetings]', ...args), warn: (...args: any[]) => console.warn('[zoom-meetings]', ...args), error: (...args: any[]) => console.error('[zoom-meetings]', ...args) }
