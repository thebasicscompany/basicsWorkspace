...
const logger = { info: (...args: any[]) => console.log('[discord-channels]', ...args), warn: (...args: any[]) => console.warn('[discord-channels]', ...args), error: (...args: any[]) => console.error('[discord-channels]', ...args) }
