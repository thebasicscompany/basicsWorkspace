...
const logger = { info: (...args: any[]) => console.log('[discord-send-message]', ...args), warn: (...args: any[]) => console.warn('[discord-send-message]', ...args), error: (...args: any[]) => console.error('[discord-send-message]', ...args) }
