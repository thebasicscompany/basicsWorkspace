...
const logger = { info: (...args: any[]) => console.log('[discord-servers]', ...args), warn: (...args: any[]) => console.warn('[discord-servers]', ...args), error: (...args: any[]) => console.error('[discord-servers]', ...args) }
