...
const logger = { info: (...args: any[]) => console.log('[asana-search-tasks]', ...args), warn: (...args: any[]) => console.warn('[asana-search-tasks]', ...args), error: (...args: any[]) => console.error('[asana-search-tasks]', ...args) }
