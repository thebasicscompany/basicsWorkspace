...
const logger = { info: (...args: any[]) => console.log('[asana-update-task]', ...args), warn: (...args: any[]) => console.warn('[asana-update-task]', ...args), error: (...args: any[]) => console.error('[asana-update-task]', ...args) }
