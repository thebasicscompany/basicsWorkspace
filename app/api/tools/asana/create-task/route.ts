...
const logger = { info: (...args: any[]) => console.log('[asana-create-task]', ...args), warn: (...args: any[]) => console.warn('[asana-create-task]', ...args), error: (...args: any[]) => console.error('[asana-create-task]', ...args) }
