...
const logger = { info: (...args: any[]) => console.log('[asana-get-task]', ...args), warn: (...args: any[]) => console.warn('[asana-get-task]', ...args), error: (...args: any[]) => console.error('[asana-get-task]', ...args) }
