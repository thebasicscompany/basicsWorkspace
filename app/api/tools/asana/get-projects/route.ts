...
const logger = { info: (...args: any[]) => console.log('[asana-get-projects]', ...args), warn: (...args: any[]) => console.warn('[asana-get-projects]', ...args), error: (...args: any[]) => console.error('[asana-get-projects]', ...args) }
