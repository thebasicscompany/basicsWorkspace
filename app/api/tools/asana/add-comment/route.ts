...
const logger = { info: (...args: any[]) => console.log('[asana-add-comment]', ...args), warn: (...args: any[]) => console.warn('[asana-add-comment]', ...args), error: (...args: any[]) => console.error('[asana-add-comment]', ...args) }
