...
const logger = { info: (...args: any[]) => console.log('[google_calendar-calendars]', ...args), warn: (...args: any[]) => console.warn('[google_calendar-calendars]', ...args), error: (...args: any[]) => console.error('[google_calendar-calendars]', ...args) }
