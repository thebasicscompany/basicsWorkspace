...
const logger = { info: (...args: any[]) => console.log('[sharepoint-site]', ...args), warn: (...args: any[]) => console.warn('[sharepoint-site]', ...args), error: (...args: any[]) => console.error('[sharepoint-site]', ...args) }
