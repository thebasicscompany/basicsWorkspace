...
const logger = { info: (...args: any[]) => console.log('[sharepoint-lists]', ...args), warn: (...args: any[]) => console.warn('[sharepoint-lists]', ...args), error: (...args: any[]) => console.error('[sharepoint-lists]', ...args) }
