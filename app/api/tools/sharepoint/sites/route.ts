...
import type { SharepointSite } from '@/lib/sim/tools/sharepoint/types'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[sharepoint-sites]', ...args), warn: (...args: any[]) => console.warn('[sharepoint-sites]', ...args), error: (...args: any[]) => console.error('[sharepoint-sites]', ...args) }
