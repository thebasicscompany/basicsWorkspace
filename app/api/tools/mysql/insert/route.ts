...
const logger = { info: (...args: any[]) => console.log('[MySQLInsertAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLInsertAPI]', ...args), error: (...args: any[]) => console.error('[MySQLInsertAPI]', ...args) }
