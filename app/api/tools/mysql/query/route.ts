...
const logger = { info: (...args: any[]) => console.log('[MySQLQueryAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLQueryAPI]', ...args), error: (...args: any[]) => console.error('[MySQLQueryAPI]', ...args) }
