...
const logger = { info: (...args: any[]) => console.log('[MySQLIntrospectAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLIntrospectAPI]', ...args), error: (...args: any[]) => console.error('[MySQLIntrospectAPI]', ...args) }
