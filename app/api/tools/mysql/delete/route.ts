...
const logger = { info: (...args: any[]) => console.log('[MySQLDeleteAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLDeleteAPI]', ...args), error: (...args: any[]) => console.error('[MySQLDeleteAPI]', ...args) }
