...
const logger = { info: (...args: any[]) => console.log('[MySQLExecuteAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLExecuteAPI]', ...args), error: (...args: any[]) => console.error('[MySQLExecuteAPI]', ...args) }
