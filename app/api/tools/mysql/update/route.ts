...
const logger = { info: (...args: any[]) => console.log('[MySQLUpdateAPI]', ...args), warn: (...args: any[]) => console.warn('[MySQLUpdateAPI]', ...args), error: (...args: any[]) => console.error('[MySQLUpdateAPI]', ...args) }
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    try {
      const { query, values } = buildUpdateQuery(params.table, params.data, params.conditions)
