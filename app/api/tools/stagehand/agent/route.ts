...
const logger = { info: (...args: any[]) => console.log('[stagehand-agent]', ...args), warn: (...args: any[]) => console.warn('[stagehand-agent]', ...args), error: (...args: any[]) => console.error('[stagehand-agent]', ...args) }
