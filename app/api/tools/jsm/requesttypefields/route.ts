...
const logger = { info: (...args: any[]) => console.log('[jsm-requesttypefields]', ...args), warn: (...args: any[]) => console.warn('[jsm-requesttypefields]', ...args), error: (...args: any[]) => console.error('[jsm-requesttypefields]', ...args) }
