...
const logger = { info: (...args: any[]) => console.log('[jsm-requesttypes]', ...args), warn: (...args: any[]) => console.warn('[jsm-requesttypes]', ...args), error: (...args: any[]) => console.error('[jsm-requesttypes]', ...args) }
