...
const logger = { info: (...args: any[]) => console.log('[jsm-organization]', ...args), warn: (...args: any[]) => console.warn('[jsm-organization]', ...args), error: (...args: any[]) => console.error('[jsm-organization]', ...args) }
