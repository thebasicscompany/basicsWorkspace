...
const logger = { info: (...args: any[]) => console.log('[jsm-approvals]', ...args), warn: (...args: any[]) => console.warn('[jsm-approvals]', ...args), error: (...args: any[]) => console.error('[jsm-approvals]', ...args) }
