...
const logger = { info: (...args: any[]) => console.log('[jsm-participants]', ...args), warn: (...args: any[]) => console.warn('[jsm-participants]', ...args), error: (...args: any[]) => console.error('[jsm-participants]', ...args) }
