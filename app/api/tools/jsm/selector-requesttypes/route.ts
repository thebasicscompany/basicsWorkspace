...
const logger = { info: (...args: any[]) => console.log('[jsm-selector-requesttypes]', ...args), warn: (...args: any[]) => console.warn('[jsm-selector-requesttypes]', ...args), error: (...args: any[]) => console.error('[jsm-selector-requesttypes]', ...args) }
