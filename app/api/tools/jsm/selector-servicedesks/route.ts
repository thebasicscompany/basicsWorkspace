...
import { getJiraCloudId, getJsmApiBaseUrl, getJsmHeaders } from '@/lib/sim/tools/jsm/utils'

const logger = { info: (...args: any[]) => console.log('[jsm-selector-servicedesks]', ...args), warn: (...args: any[]) => console.warn('[jsm-selector-servicedesks]', ...args), error: (...args: any[]) => console.error('[jsm-selector-servicedesks]', ...args) }
