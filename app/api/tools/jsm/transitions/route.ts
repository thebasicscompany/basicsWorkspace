...
const logger = { info: (...args: any[]) => console.log('[jsm-transitions]', ...args), warn: (...args: any[]) => console.warn('[jsm-transitions]', ...args), error: (...args: any[]) => console.error('[jsm-transitions]', ...args) }
