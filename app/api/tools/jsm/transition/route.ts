...
const logger = { info: (...args: any[]) => console.log('[jsm-transition]', ...args), warn: (...args: any[]) => console.warn('[jsm-transition]', ...args), error: (...args: any[]) => console.error('[jsm-transition]', ...args) }
