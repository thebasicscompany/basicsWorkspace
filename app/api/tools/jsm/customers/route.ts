...
const logger = { info: (...args: any[]) => console.log('[jsm-customers]', ...args), warn: (...args: any[]) => console.warn('[jsm-customers]', ...args), error: (...args: any[]) => console.error('[jsm-customers]', ...args) }
