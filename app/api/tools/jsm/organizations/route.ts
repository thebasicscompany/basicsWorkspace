...
const logger = { info: (...args: any[]) => console.log('[jsm-organizations]', ...args), warn: (...args: any[]) => console.warn('[jsm-organizations]', ...args), error: (...args: any[]) => console.error('[jsm-organizations]', ...args) }
