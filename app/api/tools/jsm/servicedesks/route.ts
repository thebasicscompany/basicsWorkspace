...
const logger = { info: (...args: any[]) => console.log('[jsm-servicedesks]', ...args), warn: (...args: any[]) => console.warn('[jsm-servicedesks]', ...args), error: (...args: any[]) => console.error('[jsm-servicedesks]', ...args) }
