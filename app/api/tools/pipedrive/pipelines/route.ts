...
const logger = { info: (...args: any[]) => console.log('[pipedrive-pipelines]', ...args), warn: (...args: any[]) => console.warn('[pipedrive-pipelines]', ...args), error: (...args: any[]) => console.error('[pipedrive-pipelines]', ...args) }
