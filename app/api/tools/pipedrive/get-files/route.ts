...
const logger = { info: (...args: any[]) => console.log('[pipedrive-get-files]', ...args), warn: (...args: any[]) => console.warn('[pipedrive-get-files]', ...args), error: (...args: any[]) => console.error('[pipedrive-get-files]', ...args) }
