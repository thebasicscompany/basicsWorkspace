...
import { uploadFilesForTeamsMessage } from '@/lib/sim/tools/microsoft_teams/server-utils'
import type { GraphApiErrorResponse, GraphChatMessage } from '@/lib/sim/tools/microsoft_teams/types'
import { resolveMentionsForChannel, type TeamsMention } from '@/lib/sim/tools/microsoft_teams/utils'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[microsoft_teams-write_channel]', ...args), warn: (...args: any[]) => console.warn('[microsoft_teams-write_channel]', ...args), error: (...args: any[]) => console.error('[microsoft_teams-write_channel]', ...args) }
