...
import { resolveMentionsForChat, type TeamsMention } from '@/lib/sim/tools/microsoft_teams/utils'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[microsoft_teams-write_chat]', ...args), warn: (...args: any[]) => console.warn('[microsoft_teams-write_chat]', ...args), error: (...args: any[]) => console.error('[microsoft_teams-write_chat]', ...args) }
