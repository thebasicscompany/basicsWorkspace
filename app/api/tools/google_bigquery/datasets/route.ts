...
const logger = { info: (...args: any[]) => console.log('[google_bigquery-datasets]', ...args), warn: (...args: any[]) => console.warn('[google_bigquery-datasets]', ...args), error: (...args: any[]) => console.error('[google_bigquery-datasets]', ...args) }
