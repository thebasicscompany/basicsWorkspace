...
const logger = { info: (...args: any[]) => console.log('[google_bigquery-tables]', ...args), warn: (...args: any[]) => console.warn('[google_bigquery-tables]', ...args), error: (...args: any[]) => console.error('[google_bigquery-tables]', ...args) }
