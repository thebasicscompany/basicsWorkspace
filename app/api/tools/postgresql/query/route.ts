...
const logger = { info: (...args: any[]) => console.log('[postgresql-query]', ...args), warn: (...args: any[]) => console.warn('[postgresql-query]', ...args), error: (...args: any[]) => console.error('[postgresql-query]', ...args) }
