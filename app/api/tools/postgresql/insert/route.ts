...
const logger = { info: (...args: any[]) => console.log('[postgresql-insert]', ...args), warn: (...args: any[]) => console.warn('[postgresql-insert]', ...args), error: (...args: any[]) => console.error('[postgresql-insert]', ...args) }
