...
const logger = { info: (...args: any[]) => console.log('[postgresql-update]', ...args), warn: (...args: any[]) => console.warn('[postgresql-update]', ...args), error: (...args: any[]) => console.error('[postgresql-update]', ...args) }
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    try {
      const result = await executeUpdate(sql, params.table, params.data, params.conditions)
