...
const logger = { info: (...args: any[]) => console.log('[postgresql-execute]', ...args), warn: (...args: any[]) => console.warn('[postgresql-execute]', ...args), error: (...args: any[]) => console.error('[postgresql-execute]', ...args) }
