...
const logger = { info: (...args: any[]) => console.log('[postgresql-introspect]', ...args), warn: (...args: any[]) => console.warn('[postgresql-introspect]', ...args), error: (...args: any[]) => console.error('[postgresql-introspect]', ...args) }
