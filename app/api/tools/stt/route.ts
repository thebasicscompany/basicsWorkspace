...
import type { TranscriptSegment } from '@/lib/sim/tools/stt/types'

const logger = { info: (...args: any[]) => console.log('[stt]', ...args), warn: (...args: any[]) => console.warn('[stt]', ...args), error: (...args: any[]) => console.error('[stt]', ...args) }
...
export async function POST(request: NextRequest) {
  ...
  try {
    const body = (await request.json()) as SttRequestBody
    const {
      provider,
      apiKey,
      model,
