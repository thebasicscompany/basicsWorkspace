...
const logger = { info: (...args: any[]) => console.log('[RDSUpdateAPI]', ...args), warn: (...args: any[]) => console.warn('[RDSUpdateAPI]', ...args), error: (...args: any[]) => console.error('[RDSUpdateAPI]', ...args) }
  ...
  try {
    ...
    try {
      const result = await executeUpdate(
        ...
        params.table, params.data, params.conditions
      )
