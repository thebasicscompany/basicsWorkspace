...
const logger = { info: (...args: any[]) => console.log('[RDSExecuteAPI]', ...args), warn: (...args: any[]) => console.warn('[RDSExecuteAPI]', ...args), error: (...args: any[]) => console.error('[RDSExecuteAPI]', ...args) }
  ...
  try {
    ...
    try {
      const result = await executeStatement(
        client, params.resourceArn, params.secretArn, params.database, params.query
      )
