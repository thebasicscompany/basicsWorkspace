...
const logger = { info: (...args: any[]) => console.log('[RDSDeleteAPI]', ...args), warn: (...args: any[]) => console.warn('[RDSDeleteAPI]', ...args), error: (...args: any[]) => console.error('[RDSDeleteAPI]', ...args) }
  ...
  try {
    ...
    try {
      const result = await executeDelete(
        ...
        params.table, params.conditions
      )
