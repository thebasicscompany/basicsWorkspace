...
const logger = { info: (...args: any[]) => console.log('[RDSInsertAPI]', ...args), warn: (...args: any[]) => console.warn('[RDSInsertAPI]', ...args), error: (...args: any[]) => console.error('[RDSInsertAPI]', ...args) }
  ...
  try {
    ...
    try {
      const result = await executeInsert(
        client, params.resourceArn, params.secretArn, params.database, params.table, params.data
      )
