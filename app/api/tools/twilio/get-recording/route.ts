...
const logger = { info: (...args: any[]) => console.log('[twilio-get-recording]', ...args), warn: (...args: any[]) => console.warn('[twilio-get-recording]', ...args), error: (...args: any[]) => console.error('[twilio-get-recording]', ...args) }
