...
const logger = { info: (...args: any[]) => console.log('[microsoft_excel-sheets]', ...args), warn: (...args: any[]) => console.warn('[microsoft_excel-sheets]', ...args), error: (...args: any[]) => console.error('[microsoft_excel-sheets]', ...args) }
