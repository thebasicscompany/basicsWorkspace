...
const logger = { info: (...args: any[]) => console.log('[microsoft-teams-chats]', ...args), warn: (...args: any[]) => console.warn('[microsoft-teams-chats]', ...args), error: (...args: any[]) => console.error('[microsoft-teams-chats]', ...args) }
