...
const logger = { info: (...args: any[]) => console.log('[microsoft-teams-teams]', ...args), warn: (...args: any[]) => console.warn('[microsoft-teams-teams]', ...args), error: (...args: any[]) => console.error('[microsoft-teams-teams]', ...args) }
