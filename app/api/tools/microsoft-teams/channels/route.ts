...
const logger = { info: (...args: any[]) => console.log('[microsoft-teams-channels]', ...args), warn: (...args: any[]) => console.warn('[microsoft-teams-channels]', ...args), error: (...args: any[]) => console.error('[microsoft-teams-channels]', ...args) }
