...
const logger = { info: (...args: any[]) => console.log('[ssh-delete-file]', ...args), warn: (...args: any[]) => console.warn('[ssh-delete-file]', ...args), error: (...args: any[]) => console.error('[ssh-delete-file]', ...args) }
