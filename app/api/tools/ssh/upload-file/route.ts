...
const logger = { info: (...args: any[]) => console.log('[ssh-upload-file]', ...args), warn: (...args: any[]) => console.warn('[ssh-upload-file]', ...args), error: (...args: any[]) => console.error('[ssh-upload-file]', ...args) }
