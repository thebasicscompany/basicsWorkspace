...
const logger = { info: (...args: any[]) => console.log('[ssh-read-file-content]', ...args), warn: (...args: any[]) => console.warn('[ssh-read-file-content]', ...args), error: (...args: any[]) => console.error('[ssh-read-file-content]', ...args) }
