...
const logger = { info: (...args: any[]) => console.log('[ssh-check-file-exists]', ...args), warn: (...args: any[]) => console.warn('[ssh-check-file-exists]', ...args), error: (...args: any[]) => console.error('[ssh-check-file-exists]', ...args) }
