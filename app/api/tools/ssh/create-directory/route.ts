...
const logger = { info: (...args: any[]) => console.log('[ssh-create-directory]', ...args), warn: (...args: any[]) => console.warn('[ssh-create-directory]', ...args), error: (...args: any[]) => console.error('[ssh-create-directory]', ...args) }
