...
const logger = { info: (...args: any[]) => console.log('[ssh-write-file-content]', ...args), warn: (...args: any[]) => console.warn('[ssh-write-file-content]', ...args), error: (...args: any[]) => console.error('[ssh-write-file-content]', ...args) }
