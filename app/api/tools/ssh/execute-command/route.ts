...
const logger = { info: (...args: any[]) => console.log('[ssh-execute-command]', ...args), warn: (...args: any[]) => console.warn('[ssh-execute-command]', ...args), error: (...args: any[]) => console.error('[ssh-execute-command]', ...args) }
