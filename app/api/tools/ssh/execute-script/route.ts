...
const logger = { info: (...args: any[]) => console.log('[ssh-execute-script]', ...args), warn: (...args: any[]) => console.warn('[ssh-execute-script]', ...args), error: (...args: any[]) => console.error('[ssh-execute-script]', ...args) }
