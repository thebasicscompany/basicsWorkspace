...
const logger = { info: (...args: any[]) => console.log('[ssh-check-command-exists]', ...args), warn: (...args: any[]) => console.warn('[ssh-check-command-exists]', ...args), error: (...args: any[]) => console.error('[ssh-check-command-exists]', ...args) }
