...
const logger = { info: (...args: any[]) => console.log('[ssh-get-system-info]', ...args), warn: (...args: any[]) => console.warn('[ssh-get-system-info]', ...args), error: (...args: any[]) => console.error('[ssh-get-system-info]', ...args) }
