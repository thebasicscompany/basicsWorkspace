...
const logger = { info: (...args: any[]) => console.log('[ssh-download-file]', ...args), warn: (...args: any[]) => console.warn('[ssh-download-file]', ...args), error: (...args: any[]) => console.error('[ssh-download-file]', ...args) }
