...
const logger = { info: (...args: any[]) => console.log('[ssh-move-rename]', ...args), warn: (...args: any[]) => console.warn('[ssh-move-rename]', ...args), error: (...args: any[]) => console.error('[ssh-move-rename]', ...args) }
