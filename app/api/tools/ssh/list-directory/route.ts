...
const logger = { info: (...args: any[]) => console.log('[ssh-list-directory]', ...args), warn: (...args: any[]) => console.warn('[ssh-list-directory]', ...args), error: (...args: any[]) => console.error('[ssh-list-directory]', ...args) }
