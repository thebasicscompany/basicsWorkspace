...
const logger = {
  info: (...args: any[]) => console.log('[SlackReadMessagesAPI]', ...args),
  warn: (...args: any[]) => console.warn('[SlackReadMessagesAPI]', ...args),
  error: (...args: any[]) => console.error('[SlackReadMessagesAPI]', ...args),
}
        ...
        return NextResponse.json(
          {
            success: false,
            error:
              'Bot is not in the channel. Please invite the bot to your Slack channel by typing: /invite @YourBot',
          },
          { status: 400 }
        )
      }
