...
const logger = {
  info: (...args: any[]) => console.log('[SlackUsersAPI]', ...args),
  warn: (...args: any[]) => console.warn('[SlackUsersAPI]', ...args),
  error: (...args: any[]) => console.error('[SlackUsersAPI]', ...args),
}
...
export async function POST(request: Request) {
  try {
    ...
    if (isBotToken) {
      ...
      // Full OAuth credential resolution will be wired once the OAuth infrastructure is complete.
      accessToken = credential
