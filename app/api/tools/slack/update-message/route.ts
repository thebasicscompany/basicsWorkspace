...
const logger = {
  info: (...args: any[]) => console.log('[SlackUpdateMessageAPI]', ...args),
  warn: (...args: any[]) => console.warn('[SlackUpdateMessageAPI]', ...args),
  error: (...args: any[]) => console.error('[SlackUpdateMessageAPI]', ...args),
}
