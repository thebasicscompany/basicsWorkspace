...
const logger = { info: (...args: any[]) => console.log('[sftp-download]', ...args), warn: (...args: any[]) => console.warn('[sftp-download]', ...args), error: (...args: any[]) => console.error('[sftp-download]', ...args) }
