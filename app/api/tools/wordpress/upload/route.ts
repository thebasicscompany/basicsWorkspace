...
const logger = { info: (...args: any[]) => console.log('[wordpress-upload]', ...args), warn: (...args: any[]) => console.warn('[wordpress-upload]', ...args), error: (...args: any[]) => console.error('[wordpress-upload]', ...args) }
