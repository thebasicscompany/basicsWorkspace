...
const logger = {
  info: (...args: any[]) => console.log('[GitHubLatestCommitAPI]', ...args),
  warn: (...args: any[]) => console.warn('[GitHubLatestCommitAPI]', ...args),
  error: (...args: any[]) => console.error('[GitHubLatestCommitAPI]', ...args),
}
