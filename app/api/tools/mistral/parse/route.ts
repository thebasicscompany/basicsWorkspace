...
const logger = { info: (...args: any[]) => console.log('[mistral-parse]', ...args), warn: (...args: any[]) => console.warn('[mistral-parse]', ...args), error: (...args: any[]) => console.error('[mistral-parse]', ...args) }
