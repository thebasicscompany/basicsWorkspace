...
const logger = { info: (...args: any[]) => console.log('[vision-analyze]', ...args), warn: (...args: any[]) => console.warn('[vision-analyze]', ...args), error: (...args: any[]) => console.error('[vision-analyze]', ...args) }
