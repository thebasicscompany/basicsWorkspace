...
import type { PlannerTask } from '@/lib/sim/tools/microsoft_planner/types'

const logger = { info: (...args: any[]) => console.log('[microsoft_planner-tasks]', ...args), warn: (...args: any[]) => console.warn('[microsoft_planner-tasks]', ...args), error: (...args: any[]) => console.error('[microsoft_planner-tasks]', ...args) }
