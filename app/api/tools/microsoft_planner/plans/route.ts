...
const logger = { info: (...args: any[]) => console.log('[microsoft_planner-plans]', ...args), warn: (...args: any[]) => console.warn('[microsoft_planner-plans]', ...args), error: (...args: any[]) => console.error('[microsoft_planner-plans]', ...args) }
