...
import type { VideoRequestBody } from '@/lib/sim/tools/video/types'

const logger = { info: (...args: any[]) => console.log('[video]', ...args), warn: (...args: any[]) => console.warn('[video]', ...args), error: (...args: any[]) => console.error('[video]', ...args) }
