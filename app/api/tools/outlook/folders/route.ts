...
const logger = { info: (...args: any[]) => console.log('[outlook-folders]', ...args), warn: (...args: any[]) => console.warn('[outlook-folders]', ...args), error: (...args: any[]) => console.error('[outlook-folders]', ...args) }
