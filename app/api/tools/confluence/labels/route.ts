...
const logger = { info: (...args: any[]) => console.log('[confluence-labels]', ...args), warn: (...args: any[]) => console.warn('[confluence-labels]', ...args), error: (...args: any[]) => console.error('[confluence-labels]', ...args) }
