...
const logger = { info: (...args: any[]) => console.log('[confluence-tasks]', ...args), warn: (...args: any[]) => console.warn('[confluence-tasks]', ...args), error: (...args: any[]) => console.error('[confluence-tasks]', ...args) }
