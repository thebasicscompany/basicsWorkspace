...
const logger = { info: (...args: any[]) => console.log('[confluence-comments]', ...args), warn: (...args: any[]) => console.warn('[confluence-comments]', ...args), error: (...args: any[]) => console.error('[confluence-comments]', ...args) }
