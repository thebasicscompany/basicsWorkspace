...
const logger = { info: (...args: any[]) => console.log('[confluence-space]', ...args), warn: (...args: any[]) => console.warn('[confluence-space]', ...args), error: (...args: any[]) => console.error('[confluence-space]', ...args) }
