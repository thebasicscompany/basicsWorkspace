...
const logger = { info: (...args: any[]) => console.log('[confluence-space-permissions]', ...args), warn: (...args: any[]) => console.warn('[confluence-space-permissions]', ...args), error: (...args: any[]) => console.error('[confluence-space-permissions]', ...args) }
