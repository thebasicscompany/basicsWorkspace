...
const logger = { info: (...args: any[]) => console.log('[confluence-user]', ...args), warn: (...args: any[]) => console.warn('[confluence-user]', ...args), error: (...args: any[]) => console.error('[confluence-user]', ...args) }
