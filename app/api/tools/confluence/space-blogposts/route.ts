...
const logger = { info: (...args: any[]) => console.log('[confluence-space-blogposts]', ...args), warn: (...args: any[]) => console.warn('[confluence-space-blogposts]', ...args), error: (...args: any[]) => console.error('[confluence-space-blogposts]', ...args) }
