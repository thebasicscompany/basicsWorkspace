...
const logger = { info: (...args: any[]) => console.log('[confluence-page-children]', ...args), warn: (...args: any[]) => console.warn('[confluence-page-children]', ...args), error: (...args: any[]) => console.error('[confluence-page-children]', ...args) }
