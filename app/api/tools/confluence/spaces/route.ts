...
const logger = { info: (...args: any[]) => console.log('[confluence-spaces]', ...args), warn: (...args: any[]) => console.warn('[confluence-spaces]', ...args), error: (...args: any[]) => console.error('[confluence-spaces]', ...args) }
