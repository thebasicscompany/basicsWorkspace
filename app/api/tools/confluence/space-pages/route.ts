...
const logger = { info: (...args: any[]) => console.log('[confluence-space-pages]', ...args), warn: (...args: any[]) => console.warn('[confluence-space-pages]', ...args), error: (...args: any[]) => console.error('[confluence-space-pages]', ...args) }
