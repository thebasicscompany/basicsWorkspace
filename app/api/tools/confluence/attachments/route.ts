...
const logger = { info: (...args: any[]) => console.log('[confluence-attachments]', ...args), warn: (...args: any[]) => console.warn('[confluence-attachments]', ...args), error: (...args: any[]) => console.error('[confluence-attachments]', ...args) }
