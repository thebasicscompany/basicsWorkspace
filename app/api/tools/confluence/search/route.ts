...
const logger = { info: (...args: any[]) => console.log('[confluence-search]', ...args), warn: (...args: any[]) => console.warn('[confluence-search]', ...args), error: (...args: any[]) => console.error('[confluence-search]', ...args) }
