...
const logger = { info: (...args: any[]) => console.log('[confluence-space-properties]', ...args), warn: (...args: any[]) => console.warn('[confluence-space-properties]', ...args), error: (...args: any[]) => console.error('[confluence-space-properties]', ...args) }
