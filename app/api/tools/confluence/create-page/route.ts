...
const logger = { info: (...args: any[]) => console.log('[confluence-create-page]', ...args), warn: (...args: any[]) => console.warn('[confluence-create-page]', ...args), error: (...args: any[]) => console.error('[confluence-create-page]', ...args) }
