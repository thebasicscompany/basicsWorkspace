...
const logger = { info: (...args: any[]) => console.log('[confluence-pages-by-label]', ...args), warn: (...args: any[]) => console.warn('[confluence-pages-by-label]', ...args), error: (...args: any[]) => console.error('[confluence-pages-by-label]', ...args) }
