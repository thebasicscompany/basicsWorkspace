...
const logger = { info: (...args: any[]) => console.log('[confluence-search-in-space]', ...args), warn: (...args: any[]) => console.warn('[confluence-search-in-space]', ...args), error: (...args: any[]) => console.error('[confluence-search-in-space]', ...args) }
