...
const logger = { info: (...args: any[]) => console.log('[confluence-pages]', ...args), warn: (...args: any[]) => console.warn('[confluence-pages]', ...args), error: (...args: any[]) => console.error('[confluence-pages]', ...args) }
