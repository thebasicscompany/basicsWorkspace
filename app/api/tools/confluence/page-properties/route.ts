...
const logger = { info: (...args: any[]) => console.log('[confluence-page-properties]', ...args), warn: (...args: any[]) => console.warn('[confluence-page-properties]', ...args), error: (...args: any[]) => console.error('[confluence-page-properties]', ...args) }
