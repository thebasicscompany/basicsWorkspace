...
const logger = { info: (...args: any[]) => console.log('[confluence-page-descendants]', ...args), warn: (...args: any[]) => console.warn('[confluence-page-descendants]', ...args), error: (...args: any[]) => console.error('[confluence-page-descendants]', ...args) }
