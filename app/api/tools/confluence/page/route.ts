...
const logger = { info: (...args: any[]) => console.log('[confluence-page]', ...args), warn: (...args: any[]) => console.warn('[confluence-page]', ...args), error: (...args: any[]) => console.error('[confluence-page]', ...args) }
...
const postPageSchema = z
  ...
  .refine(
    (data) => validateAlphanumericId(data.pageId, 'pageId', 255).isValid,
    { message: 'Invalid page ID', path: ['pageId'] }
  )
