...
import { cleanHtmlContent, getConfluenceCloudId } from '@/lib/tools/confluence/utils'

const logger = { info: (...args: any[]) => console.log('[confluence-page-versions]', ...args), warn: (...args: any[]) => console.warn('[confluence-page-versions]', ...args), error: (...args: any[]) => console.error('[confluence-page-versions]', ...args) }
