...
const logger = { info: (...args: any[]) => console.log('[a2a-get-agent-card]', ...args), warn: (...args: any[]) => console.warn('[a2a-get-agent-card]', ...args), error: (...args: any[]) => console.error('[a2a-get-agent-card]', ...args) }
