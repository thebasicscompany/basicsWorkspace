...
const logger = { info: (...args: any[]) => console.log('[a2a-send-message]', ...args), warn: (...args: any[]) => console.warn('[a2a-send-message]', ...args), error: (...args: any[]) => console.error('[a2a-send-message]', ...args) }
