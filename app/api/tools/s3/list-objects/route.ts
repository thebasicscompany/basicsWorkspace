...
const logger = { info: (...args: any[]) => console.log('[s3-list-objects]', ...args), warn: (...args: any[]) => console.warn('[s3-list-objects]', ...args), error: (...args: any[]) => console.error('[s3-list-objects]', ...args) }
