...
const logger = { info: (...args: any[]) => console.log('[s3-delete-object]', ...args), warn: (...args: any[]) => console.warn('[s3-delete-object]', ...args), error: (...args: any[]) => console.error('[s3-delete-object]', ...args) }
