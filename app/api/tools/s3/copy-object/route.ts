...
const logger = { info: (...args: any[]) => console.log('[s3-copy-object]', ...args), warn: (...args: any[]) => console.warn('[s3-copy-object]', ...args), error: (...args: any[]) => console.error('[s3-copy-object]', ...args) }
