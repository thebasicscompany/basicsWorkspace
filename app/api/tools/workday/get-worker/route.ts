...
const logger = { info: (...args: any[]) => console.log('[workday-get-worker]', ...args), warn: (...args: any[]) => console.warn('[workday-get-worker]', ...args), error: (...args: any[]) => console.error('[workday-get-worker]', ...args) }
