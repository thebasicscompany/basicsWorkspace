...
} from '@/lib/sim/tools/workday/soap'

export const dynamic = 'force-dynamic'

const logger = { info: (...args: any[]) => console.log('[workday-get-organizations]', ...args), warn: (...args: any[]) => console.warn('[workday-get-organizations]', ...args), error: (...args: any[]) => console.error('[workday-get-organizations]', ...args) }
