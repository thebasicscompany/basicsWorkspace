...
const logger = { info: (...args: any[]) => console.log('[workday-list-workers]', ...args), warn: (...args: any[]) => console.warn('[workday-list-workers]', ...args), error: (...args: any[]) => console.error('[workday-list-workers]', ...args) }
