...
const logger = { info: (...args: any[]) => console.log('[workday-change-job]', ...args), warn: (...args: any[]) => console.warn('[workday-change-job]', ...args), error: (...args: any[]) => console.error('[workday-change-job]', ...args) }
