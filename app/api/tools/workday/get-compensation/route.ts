...
const logger = { info: (...args: any[]) => console.log('[workday-get-compensation]', ...args), warn: (...args: any[]) => console.warn('[workday-get-compensation]', ...args), error: (...args: any[]) => console.error('[workday-get-compensation]', ...args) }
