...
const logger = { info: (...args: any[]) => console.log('[workday-update-worker]', ...args), warn: (...args: any[]) => console.warn('[workday-update-worker]', ...args), error: (...args: any[]) => console.error('[workday-update-worker]', ...args) }
