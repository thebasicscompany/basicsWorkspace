...
const logger = { info: (...args: any[]) => console.log('[workday-create-prehire]', ...args), warn: (...args: any[]) => console.warn('[workday-create-prehire]', ...args), error: (...args: any[]) => console.error('[workday-create-prehire]', ...args) }
