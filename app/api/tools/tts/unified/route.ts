...
import type {
  ...
  TtsProvider,
  TtsResponse,
} from '@/lib/sim/tools/tts/types'
import { getFileExtension, getMimeType } from '@/lib/sim/tools/tts/types'

const logger = { info: (...args: any[]) => console.log('[tts-unified]', ...args), warn: (...args: any[]) => console.warn('[tts-unified]', ...args), error: (...args: any[]) => console.error('[tts-unified]', ...args) }
