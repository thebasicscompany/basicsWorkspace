...
const logger = { info: (...args: any[]) => console.log('[calcom-event-types]', ...args), warn: (...args: any[]) => console.warn('[calcom-event-types]', ...args), error: (...args: any[]) => console.error('[calcom-event-types]', ...args) }
