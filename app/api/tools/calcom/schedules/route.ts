...
const logger = { info: (...args: any[]) => console.log('[calcom-schedules]', ...args), warn: (...args: any[]) => console.warn('[calcom-schedules]', ...args), error: (...args: any[]) => console.error('[calcom-schedules]', ...args) }
