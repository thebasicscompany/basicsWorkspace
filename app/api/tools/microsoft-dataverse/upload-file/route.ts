...
const logger = { info: (...args: any[]) => console.log('[microsoft-dataverse-upload-file]', ...args), warn: (...args: any[]) => console.warn('[microsoft-dataverse-upload-file]', ...args), error: (...args: any[]) => console.error('[microsoft-dataverse-upload-file]', ...args) }
