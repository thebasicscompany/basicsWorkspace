import { createTool, createV2Tool } from '@/lib/sim/tools/google_calendar/create'
import { deleteTool, deleteV2Tool } from '@/lib/sim/tools/google_calendar/delete'
import { freebusyTool, freebusyV2Tool } from '@/lib/sim/tools/google_calendar/freebusy'
import { getTool, getV2Tool } from '@/lib/sim/tools/google_calendar/get'
import { instancesTool, instancesV2Tool } from '@/lib/sim/tools/google_calendar/instances'
import { inviteTool, inviteV2Tool } from '@/lib/sim/tools/google_calendar/invite'
import { listTool, listV2Tool } from '@/lib/sim/tools/google_calendar/list'
import { listCalendarsTool, listCalendarsV2Tool } from '@/lib/sim/tools/google_calendar/list_calendars'
import { moveTool, moveV2Tool } from '@/lib/sim/tools/google_calendar/move'
import { quickAddTool, quickAddV2Tool } from '@/lib/sim/tools/google_calendar/quick_add'
import { updateTool, updateV2Tool } from '@/lib/sim/tools/google_calendar/update'
