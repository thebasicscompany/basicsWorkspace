import type { PipedriveGetFilesParams, PipedriveGetFilesResponse } from '@/lib/sim/tools/pipedrive/types'
import { PIPEDRIVE_FILE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/pipedrive/types'
