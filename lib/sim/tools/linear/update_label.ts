import type { LinearUpdateLabelParams, LinearUpdateLabelResponse } from '@/lib/sim/tools/linear/types'
import { LABEL_FULL_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
