import type { LinearUpdateCommentParams, LinearUpdateCommentResponse } from '@/lib/sim/tools/linear/types'
import { COMMENT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
