import type { LinearListProjectsParams, LinearListProjectsResponse } from '@/lib/sim/tools/linear/types'
import { PAGE_INFO_OUTPUT, PROJECT_FULL_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
