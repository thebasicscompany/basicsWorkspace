import type { LinearListCommentsParams, LinearListCommentsResponse } from '@/lib/sim/tools/linear/types'
import { COMMENT_OUTPUT_PROPERTIES, PAGE_INFO_OUTPUT } from '@/lib/sim/tools/linear/types'
