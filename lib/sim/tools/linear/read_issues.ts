import type { LinearReadIssuesParams, LinearReadIssuesResponse } from '@/lib/sim/tools/linear/types'
import { ISSUE_LIST_OUTPUT_PROPERTIES, PAGE_INFO_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
