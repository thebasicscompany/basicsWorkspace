import type { LinearUpdateCustomerParams, LinearUpdateCustomerResponse } from '@/lib/sim/tools/linear/types'
import { CUSTOMER_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
