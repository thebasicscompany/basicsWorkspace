import type { LinearCreateIssueParams, LinearCreateIssueResponse } from '@/lib/sim/tools/linear/types'
import { ISSUE_EXTENDED_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
