import type { LinearUpdateProjectParams, LinearUpdateProjectResponse } from '@/lib/sim/tools/linear/types'
import { PROJECT_FULL_OUTPUT_PROPERTIES } from '@/lib/sim/tools/linear/types'
