import type { GoogleAdsSearchParams, GoogleAdsSearchResponse } from '@/lib/sim/tools/google_ads/types'
import { validateNumericId } from '@/lib/sim/tools/google_ads/types'
