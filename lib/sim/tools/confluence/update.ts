import type { ConfluenceUpdateParams, ConfluenceUpdateResponse } from '@/lib/sim/tools/confluence/types'
import { CONTENT_BODY_OUTPUT_PROPERTIES, VERSION_OUTPUT_PROPERTIES } from '@/lib/sim/tools/confluence/types'
