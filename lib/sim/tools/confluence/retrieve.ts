import type { ConfluenceRetrieveParams, ConfluenceRetrieveResponse } from '@/lib/sim/tools/confluence/types'
import {
  BODY_FORMAT_PROPERTIES,
  TIMESTAMP_OUTPUT,
  VERSION_OUTPUT_PROPERTIES,
} from '@/lib/sim/tools/confluence/types'
import { transformPageData } from '@/lib/sim/tools/confluence/utils'
