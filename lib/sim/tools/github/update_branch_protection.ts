import type { BranchProtectionResponse, UpdateBranchProtectionParams } from '@/lib/sim/tools/github/types'
import { BRANCH_PROTECTION_OUTPUT_PROPERTIES } from '@/lib/sim/tools/github/types'
