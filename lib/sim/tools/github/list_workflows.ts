import type { ListWorkflowsParams, ListWorkflowsResponse } from '@/lib/sim/tools/github/types'
import { WORKFLOW_OUTPUT_PROPERTIES } from '@/lib/sim/tools/github/types'
