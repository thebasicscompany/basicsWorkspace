import type { CreateIssueCommentParams, IssueCommentResponse } from '@/lib/sim/tools/github/types'
import { COMMENT_OUTPUT_PROPERTIES, USER_OUTPUT } from '@/lib/sim/tools/github/types'
