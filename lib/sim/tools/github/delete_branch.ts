import type { DeleteBranchParams, DeleteBranchResponse } from '@/lib/sim/tools/github/types'
import { DELETE_BRANCH_OUTPUT_PROPERTIES } from '@/lib/sim/tools/github/types'
