import { addAssigneesTool, addAssigneesV2Tool } from '@/lib/sim/tools/github/add_assignees'
import { addLabelsTool, addLabelsV2Tool } from '@/lib/sim/tools/github/add_labels'
import { cancelWorkflowRunTool, cancelWorkflowRunV2Tool } from '@/lib/sim/tools/github/cancel_workflow_run'
import { checkStarTool, checkStarV2Tool } from '@/lib/sim/tools/github/check_star'
import { closeIssueTool, closeIssueV2Tool } from '@/lib/sim/tools/github/close_issue'
import { closePRTool, closePRV2Tool } from '@/lib/sim/tools/github/close_pr'
import { commentTool, commentV2Tool } from '@/lib/sim/tools/github/comment'
import { compareCommitsTool, compareCommitsV2Tool } from '@/lib/sim/tools/github/compare_commits'
import { createBranchTool, createBranchV2Tool } from '@/lib/sim/tools/github/create_branch'
import {
  createCommentReactionTool,
  createCommentReactionV2Tool,
} from '@/lib/sim/tools/github/create_comment_reaction'
import { createFileTool, createFileV2Tool } from '@/lib/sim/tools/github/create_file'
import { createGistTool, createGistV2Tool } from '@/lib/sim/tools/github/create_gist'
import { createIssueTool, createIssueV2Tool } from '@/lib/sim/tools/github/create_issue'
import {
  createIssueReactionTool,
  createIssueReactionV2Tool,
} from '@/lib/sim/tools/github/create_issue_reaction'
import { createMilestoneTool, createMilestoneV2Tool } from '@/lib/sim/tools/github/create_milestone'
import { createPRTool, createPRV2Tool } from '@/lib/sim/tools/github/create_pr'
import { createProjectTool, createProjectV2Tool } from '@/lib/sim/tools/github/create_project'
import { createReleaseTool, createReleaseV2Tool } from '@/lib/sim/tools/github/create_release'
import { deleteBranchTool, deleteBranchV2Tool } from '@/lib/sim/tools/github/delete_branch'
import { deleteCommentTool, deleteCommentV2Tool } from '@/lib/sim/tools/github/delete_comment'
import {
  deleteCommentReactionTool,
  deleteCommentReactionV2Tool,
} from '@/lib/sim/tools/github/delete_comment_reaction'
import { deleteFileTool, deleteFileV2Tool } from '@/lib/sim/tools/github/delete_file'
import { deleteGistTool, deleteGistV2Tool } from '@/lib/sim/tools/github/delete_gist'
import {
  deleteIssueReactionTool,
  deleteIssueReactionV2Tool,
} from '@/lib/sim/tools/github/delete_issue_reaction'
import { deleteMilestoneTool, deleteMilestoneV2Tool } from '@/lib/sim/tools/github/delete_milestone'
import { deleteProjectTool, deleteProjectV2Tool } from '@/lib/sim/tools/github/delete_project'
import { deleteReleaseTool, deleteReleaseV2Tool } from '@/lib/sim/tools/github/delete_release'
import { forkGistTool, forkGistV2Tool } from '@/lib/sim/tools/github/fork_gist'
import { forkRepoTool, forkRepoV2Tool } from '@/lib/sim/tools/github/fork_repo'
import { getBranchTool, getBranchV2Tool } from '@/lib/sim/tools/github/get_branch'
import {
  getBranchProtectionTool,
  getBranchProtectionV2Tool,
} from '@/lib/sim/tools/github/get_branch_protection'
import { getCommitTool, getCommitV2Tool } from '@/lib/sim/tools/github/get_commit'
import { getFileContentTool, getFileContentV2Tool } from '@/lib/sim/tools/github/get_file_content'
import { getGistTool, getGistV2Tool } from '@/lib/sim/tools/github/get_gist'
import { getIssueTool, getIssueV2Tool } from '@/lib/sim/tools/github/get_issue'
import { getMilestoneTool, getMilestoneV2Tool } from '@/lib/sim/tools/github/get_milestone'
import { getPRFilesTool, getPRFilesV2Tool } from '@/lib/sim/tools/github/get_pr_files'
import { getProjectTool, getProjectV2Tool } from '@/lib/sim/tools/github/get_project'
import { getReleaseTool, getReleaseV2Tool } from '@/lib/sim/tools/github/get_release'
import { getTreeTool, getTreeV2Tool } from '@/lib/sim/tools/github/get_tree'
import { getWorkflowTool, getWorkflowV2Tool } from '@/lib/sim/tools/github/get_workflow'
import { getWorkflowRunTool, getWorkflowRunV2Tool } from '@/lib/sim/tools/github/get_workflow_run'
import { issueCommentTool, issueCommentV2Tool } from '@/lib/sim/tools/github/issue_comment'
import { latestCommitTool, latestCommitV2Tool } from '@/lib/sim/tools/github/latest_commit'
import { listBranchesTool, listBranchesV2Tool } from '@/lib/sim/tools/github/list_branches'
import { listCommitsTool, listCommitsV2Tool } from '@/lib/sim/tools/github/list_commits'
import { listForksTool, listForksV2Tool } from '@/lib/sim/tools/github/list_forks'
import { listGistsTool, listGistsV2Tool } from '@/lib/sim/tools/github/list_gists'
import { listIssueCommentsTool, listIssueCommentsV2Tool } from '@/lib/sim/tools/github/list_issue_comments'
import { listIssuesTool, listIssuesV2Tool } from '@/lib/sim/tools/github/list_issues'
import { listMilestonesTool, listMilestonesV2Tool } from '@/lib/sim/tools/github/list_milestones'
import { listPRCommentsTool, listPRCommentsV2Tool } from '@/lib/sim/tools/github/list_pr_comments'
import { listProjectsTool, listProjectsV2Tool } from '@/lib/sim/tools/github/list_projects'
import { listPRsTool, listPRsV2Tool } from '@/lib/sim/tools/github/list_prs'
import { listReleasesTool, listReleasesV2Tool } from '@/lib/sim/tools/github/list_releases'
import { listStargazersTool, listStargazersV2Tool } from '@/lib/sim/tools/github/list_stargazers'
import { listWorkflowRunsTool, listWorkflowRunsV2Tool } from '@/lib/sim/tools/github/list_workflow_runs'
import { listWorkflowsTool, listWorkflowsV2Tool } from '@/lib/sim/tools/github/list_workflows'
import { mergePRTool, mergePRV2Tool } from '@/lib/sim/tools/github/merge_pr'
import { prTool, prV2Tool } from '@/lib/sim/tools/github/pr'
import { removeLabelTool, removeLabelV2Tool } from '@/lib/sim/tools/github/remove_label'
import { repoInfoTool, repoInfoV2Tool } from '@/lib/sim/tools/github/repo_info'
import { requestReviewersTool, requestReviewersV2Tool } from '@/lib/sim/tools/github/request_reviewers'
import { rerunWorkflowTool, rerunWorkflowV2Tool } from '@/lib/sim/tools/github/rerun_workflow'
import { searchCodeTool, searchCodeV2Tool } from '@/lib/sim/tools/github/search_code'
import { searchCommitsTool, searchCommitsV2Tool } from '@/lib/sim/tools/github/search_commits'
import { searchIssuesTool, searchIssuesV2Tool } from '@/lib/sim/tools/github/search_issues'
import { searchReposTool, searchReposV2Tool } from '@/lib/sim/tools/github/search_repos'
import { searchUsersTool, searchUsersV2Tool } from '@/lib/sim/tools/github/search_users'
import { starGistTool, starGistV2Tool } from '@/lib/sim/tools/github/star_gist'
import { starRepoTool, starRepoV2Tool } from '@/lib/sim/tools/github/star_repo'
import { triggerWorkflowTool, triggerWorkflowV2Tool } from '@/lib/sim/tools/github/trigger_workflow'
import { unstarGistTool, unstarGistV2Tool } from '@/lib/sim/tools/github/unstar_gist'
import { unstarRepoTool, unstarRepoV2Tool } from '@/lib/sim/tools/github/unstar_repo'
import {
  updateBranchProtectionTool,
  updateBranchProtectionV2Tool,
} from '@/lib/sim/tools/github/update_branch_protection'
import { updateCommentTool, updateCommentV2Tool } from '@/lib/sim/tools/github/update_comment'
import { updateFileTool, updateFileV2Tool } from '@/lib/sim/tools/github/update_file'
import { updateGistTool, updateGistV2Tool } from '@/lib/sim/tools/github/update_gist'
import { updateIssueTool, updateIssueV2Tool } from '@/lib/sim/tools/github/update_issue'
import { updateMilestoneTool, updateMilestoneV2Tool } from '@/lib/sim/tools/github/update_milestone'
import { updatePRTool, updatePRV2Tool } from '@/lib/sim/tools/github/update_pr'
import { updateProjectTool, updateProjectV2Tool } from '@/lib/sim/tools/github/update_project'
import { updateReleaseTool, updateReleaseV2Tool } from '@/lib/sim/tools/github/update_release'
