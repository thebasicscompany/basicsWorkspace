import type { JsmGetParticipantsParams, JsmGetParticipantsResponse } from '@/lib/sim/tools/jsm/types'
import { PARTICIPANT_ITEM_PROPERTIES } from '@/lib/sim/tools/jsm/types'
