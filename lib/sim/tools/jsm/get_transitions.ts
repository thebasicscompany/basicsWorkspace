import type { JsmGetTransitionsParams, JsmGetTransitionsResponse } from '@/lib/sim/tools/jsm/types'
import { TRANSITION_ITEM_PROPERTIES } from '@/lib/sim/tools/jsm/types'
