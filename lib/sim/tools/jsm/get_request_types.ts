import type { JsmGetRequestTypesParams, JsmGetRequestTypesResponse } from '@/lib/sim/tools/jsm/types'
import { REQUEST_TYPE_ITEM_PROPERTIES } from '@/lib/sim/tools/jsm/types'
