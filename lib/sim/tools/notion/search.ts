import type { NotionResponse, NotionSearchParams } from '@/lib/sim/tools/notion/types'
import { PAGINATION_OUTPUT_PROPERTIES, SEARCH_RESULTS_OUTPUT } from '@/lib/sim/tools/notion/types'
import { extractTitleFromItem } from '@/lib/sim/tools/notion/utils'
