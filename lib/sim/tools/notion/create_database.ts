import type { NotionCreateDatabaseParams, NotionResponse } from '@/lib/sim/tools/notion/types'
import { DATABASE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/notion/types'
