import type { SearchParams, SearchResponse, SearchResult } from '@/lib/sim/tools/serper/types'
import { SERPER_SEARCH_RESULT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/serper/types'
