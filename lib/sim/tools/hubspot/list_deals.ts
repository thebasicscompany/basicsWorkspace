...
import type { HubSpotListDealsParams, HubSpotListDealsResponse } from '@/lib/sim/tools/hubspot/types'
import { DEALS_ARRAY_OUTPUT, METADATA_OUTPUT, PAGING_OUTPUT } from '@/lib/sim/tools/hubspot/types'
