import type { GoogleDocsReadResponse, GoogleDocsToolParams } from '@/lib/sim/tools/google_docs/types'
import { extractTextFromDocument } from '@/lib/sim/tools/google_docs/utils'
