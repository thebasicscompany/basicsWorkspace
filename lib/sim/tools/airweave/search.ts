import type { AirweaveSearchParams, AirweaveSearchResponse } from '@/lib/sim/tools/airweave/types'
import { AIRWEAVE_SEARCH_RESULT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/airweave/types'
