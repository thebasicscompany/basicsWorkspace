import type { MailchimpInterestCategory } from '@/lib/sim/tools/mailchimp/types'
import { buildMailchimpUrl, handleMailchimpError } from '@/lib/sim/tools/mailchimp/types'
