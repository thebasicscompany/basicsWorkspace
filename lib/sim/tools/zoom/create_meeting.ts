...
import type { ZoomCreateMeetingParams, ZoomCreateMeetingResponse } from '@/lib/sim/tools/zoom/types'
import { MEETING_OUTPUT_PROPERTIES } from '@/lib/sim/tools/zoom/types'
