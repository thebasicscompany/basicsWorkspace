...
import type { SalesforceQueryParams, SalesforceQueryResponse } from '@/lib/sim/tools/salesforce/types'
import { QUERY_OUTPUT_PROPERTIES } from '@/lib/sim/tools/salesforce/types'
import { extractErrorMessage, getInstanceUrl } from '@/lib/sim/tools/salesforce/utils'
