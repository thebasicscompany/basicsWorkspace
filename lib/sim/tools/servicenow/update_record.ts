...
import type { ServiceNowUpdateParams, ServiceNowUpdateResponse } from '@/lib/sim/tools/servicenow/types'
import { createBasicAuthHeader } from '@/lib/sim/tools/servicenow/utils'
