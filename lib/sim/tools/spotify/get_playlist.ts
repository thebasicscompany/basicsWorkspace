import type { SpotifyGetPlaylistParams, SpotifyGetPlaylistResponse } from '@/lib/sim/tools/spotify/types'
import { PLAYLIST_OWNER_OUTPUT_PROPERTIES } from '@/lib/sim/tools/spotify/types'
