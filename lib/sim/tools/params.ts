...
import type { SubBlockConfig as BlockSubBlockConfig, GenerationType } from '@/lib/sim/blocks/types'
import { safeAssign } from '@/lib/sim/tools/safe-assign'
import { isEmptyTagValue } from '@/lib/sim/tools/shared/tags'
import type { OAuthConfig, ParameterVisibility, ToolConfig } from '@/lib/sim/tools/types'
...
async function fetchWorkflowInputFields(
  ...
  try {
    const { buildAuthHeaders, buildAPIUrl } = await import('@/lib/sim/executor/utils/http')
