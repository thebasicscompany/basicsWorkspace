...
} from '@/lib/sim/tools/textract/types'
...
// @ts-ignore — spread from V1 tool has compatible runtime shape despite generic type mismatch
export const textractParserV2Tool: ToolConfig<TextractParserV2Input, TextractParserOutput> = {
  ...
  // @ts-ignore — spreads V1 request; url/method/headers use V1 input type at runtime
  request: {
