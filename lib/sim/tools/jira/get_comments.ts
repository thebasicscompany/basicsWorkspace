import type { JiraGetCommentsParams, JiraGetCommentsResponse } from '@/lib/sim/tools/jira/types'
import { COMMENT_ITEM_PROPERTIES, TIMESTAMP_OUTPUT } from '@/lib/sim/tools/jira/types'
