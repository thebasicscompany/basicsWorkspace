import type { JiraRetrieveBulkParams, JiraRetrieveResponseBulk } from '@/lib/sim/tools/jira/types'
import { TIMESTAMP_OUTPUT } from '@/lib/sim/tools/jira/types'
import { extractAdfText } from '@/lib/sim/tools/jira/utils'
