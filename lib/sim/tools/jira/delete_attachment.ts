import type { JiraDeleteAttachmentParams, JiraDeleteAttachmentResponse } from '@/lib/sim/tools/jira/types'
import { SUCCESS_OUTPUT, TIMESTAMP_OUTPUT } from '@/lib/sim/tools/jira/types'
import { getJiraCloudId } from '@/lib/sim/tools/jira/utils'
