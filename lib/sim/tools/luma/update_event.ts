import type { LumaUpdateEventParams, LumaUpdateEventResponse } from '@/lib/sim/tools/luma/types'
import { LUMA_EVENT_OUTPUT_PROPERTIES, LUMA_HOST_OUTPUT_PROPERTIES } from '@/lib/sim/tools/luma/types'
