...
import type { WealthboxWriteParams, WealthboxWriteResponse } from '@/lib/sim/tools/wealthbox/types'
import { formatTaskResponse, validateAndBuildTaskBody } from '@/lib/sim/tools/wealthbox/utils'
