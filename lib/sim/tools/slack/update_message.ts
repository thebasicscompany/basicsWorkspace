import type { SlackUpdateMessageParams, SlackUpdateMessageResponse } from '@/lib/sim/tools/slack/types'
import { MESSAGE_METADATA_OUTPUT_PROPERTIES, MESSAGE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/slack/types'
