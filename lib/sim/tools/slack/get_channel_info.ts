import type { SlackGetChannelInfoParams, SlackGetChannelInfoResponse } from '@/lib/sim/tools/slack/types'
import { CHANNEL_OUTPUT_PROPERTIES } from '@/lib/sim/tools/slack/types'
