import type { SlackRemoveReactionParams, SlackRemoveReactionResponse } from '@/lib/sim/tools/slack/types'
import { REACTION_METADATA_OUTPUT_PROPERTIES } from '@/lib/sim/tools/slack/types'
