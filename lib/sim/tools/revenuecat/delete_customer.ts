import type { DeleteCustomerParams, DeleteCustomerResponse } from '@/lib/sim/tools/revenuecat/types'
import { DELETE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/revenuecat/types'
