...
import type { StagehandAgentParams, StagehandAgentResponse } from '@/lib/sim/tools/stagehand/types'
import { STAGEHAND_AGENT_RESULT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/stagehand/types'
