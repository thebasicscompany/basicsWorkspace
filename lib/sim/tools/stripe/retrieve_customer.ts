import type { CustomerResponse, RetrieveCustomerParams } from '@/lib/sim/tools/stripe/types'
import { CUSTOMER_METADATA_OUTPUT_PROPERTIES, CUSTOMER_OUTPUT } from '@/lib/sim/tools/stripe/types'
