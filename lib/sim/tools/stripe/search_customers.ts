import type { CustomerListResponse, SearchCustomersParams } from '@/lib/sim/tools/stripe/types'
import { CUSTOMER_OUTPUT, LIST_METADATA_OUTPUT_PROPERTIES } from '@/lib/sim/tools/stripe/types'
