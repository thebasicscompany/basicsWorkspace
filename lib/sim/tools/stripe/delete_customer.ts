import type { CustomerDeleteResponse, DeleteCustomerParams } from '@/lib/sim/tools/stripe/types'
import { DELETE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/stripe/types'
