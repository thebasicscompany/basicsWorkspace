import type { ShopifyCustomersResponse, ShopifyListCustomersParams } from '@/lib/sim/tools/shopify/types'
import { CUSTOMER_OUTPUT_PROPERTIES, PAGE_INFO_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
