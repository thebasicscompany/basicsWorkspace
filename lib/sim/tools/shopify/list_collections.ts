import type { ShopifyBaseParams } from '@/lib/sim/tools/shopify/types'
import { COLLECTION_OUTPUT_PROPERTIES, PAGE_INFO_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
