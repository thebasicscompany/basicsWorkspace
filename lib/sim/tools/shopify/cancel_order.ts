import type { ShopifyCancelOrderParams, ShopifyOrderResponse } from '@/lib/sim/tools/shopify/types'
import { CANCEL_ORDER_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
