import type { ShopifyProductResponse, ShopifyUpdateProductParams } from '@/lib/sim/tools/shopify/types'
import { PRODUCT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
