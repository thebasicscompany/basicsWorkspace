import type { ShopifyListProductsParams, ShopifyProductsResponse } from '@/lib/sim/tools/shopify/types'
import { PAGE_INFO_OUTPUT_PROPERTIES, PRODUCT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
