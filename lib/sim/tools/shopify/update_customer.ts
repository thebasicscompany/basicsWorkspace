import type { ShopifyCustomerResponse, ShopifyUpdateCustomerParams } from '@/lib/sim/tools/shopify/types'
import { CUSTOMER_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
