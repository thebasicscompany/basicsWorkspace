import type { ShopifyListOrdersParams, ShopifyOrdersResponse } from '@/lib/sim/tools/shopify/types'
import { ORDER_OUTPUT_PROPERTIES, PAGE_INFO_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
