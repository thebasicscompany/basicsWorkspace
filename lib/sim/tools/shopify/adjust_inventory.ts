import type { ShopifyAdjustInventoryParams, ShopifyInventoryResponse } from '@/lib/sim/tools/shopify/types'
import { INVENTORY_ADJUSTMENT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
