import type { ShopifyOrderResponse, ShopifyUpdateOrderParams } from '@/lib/sim/tools/shopify/types'
import { ORDER_OUTPUT_PROPERTIES } from '@/lib/sim/tools/shopify/types'
