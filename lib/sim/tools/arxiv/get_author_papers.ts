import type { ArxivGetAuthorPapersParams, ArxivGetAuthorPapersResponse } from '@/lib/sim/tools/arxiv/types'
import { extractTotalResults, parseArxivXML } from '@/lib/sim/tools/arxiv/utils'
