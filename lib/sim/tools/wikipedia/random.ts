...
import type { WikipediaRandomPageResponse } from '@/lib/sim/tools/wikipedia/types'
import { WIKIPEDIA_RANDOM_PAGE_OUTPUT_PROPERTIES } from '@/lib/sim/tools/wikipedia/types'
