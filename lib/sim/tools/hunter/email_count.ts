import type { HunterEmailCountParams, HunterEmailCountResponse } from '@/lib/sim/tools/hunter/types'
import { DEPARTMENT_OUTPUT, SENIORITY_OUTPUT } from '@/lib/sim/tools/hunter/types'
