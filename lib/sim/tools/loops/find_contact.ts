import type { LoopsFindContactParams, LoopsFindContactResponse } from '@/lib/sim/tools/loops/types'
import { LOOPS_CONTACT_OUTPUT_PROPERTIES } from '@/lib/sim/tools/loops/types'
