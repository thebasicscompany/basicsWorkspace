import type { CalcomListSchedulesParams, CalcomListSchedulesResponse } from '@/lib/sim/tools/calcom/types'
import { SCHEDULE_DATA_OUTPUT_PROPERTIES } from '@/lib/sim/tools/calcom/types'
