...
import { buildLoopIndexCondition, DEFAULTS, EDGE, PARALLEL } from '@/lib/sim/executor/constants'
...
import { replaceValidReferences } from '@/lib/sim/executor/utils/reference-validation'
import {
  addSubflowErrorLog,
