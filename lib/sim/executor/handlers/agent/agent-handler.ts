...
} from '@/lib/ee/access-control/utils/permission-check'
...
import { getTool, getToolAsync } from '@/lib/sim/tools/utils'
...
export class AgentBlockHandler implements BlockHandler {
  ...
  private async createCustomTool(ctx: ExecutionContext, tool: ToolInput): Promise<any> {
    ...
    const { filterSchemaForLLM } = await import('@/lib/sim/tools/params')
