...
import type { BlockOutput, OutputFieldDefinition, SubBlockConfig } from '@/lib/sim/blocks/types'
import {
  getHostedModels,
...
import { useProvidersStore } from '@/apps/automations/stores/providers/store'
...
function shouldRequireApiKeyForModel(model: string): boolean {
  ...
  // @ts-ignore — isHosted is a function; intentionally checking function reference as truthy
