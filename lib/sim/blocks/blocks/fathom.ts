import { FathomIcon } from '@/apps/automations/components/icons'
import { AuthMode, type BlockConfig } from '@/lib/sim/blocks/types'
import type { FathomResponse } from '@/lib/sim/tools/fathom/types'
import { getTrigger } from '@/lib/sim/triggers'
import { fathomTriggerOptions } from '@/lib/sim/triggers/fathom/utils'
