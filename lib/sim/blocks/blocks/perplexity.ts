import { PerplexityIcon } from '@/apps/automations/components/icons'
import { AuthMode, type BlockConfig } from '@/lib/sim/blocks/types'
import type { PerplexityChatResponse, PerplexitySearchResponse } from '@/lib/sim/tools/perplexity/types'
