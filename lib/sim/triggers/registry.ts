import { airtableWebhookTrigger } from '@/lib/sim/triggers/airtable'
import {
...
} from '@/lib/sim/triggers/confluence'
import { fathomNewMeetingTrigger, fathomWebhookTrigger } from '@/lib/sim/triggers/fathom'
import { firefliesTranscriptionCompleteTrigger } from '@/lib/sim/triggers/fireflies'
import { genericWebhookTrigger } from '@/lib/sim/triggers/generic'
import {
...
} from '@/lib/sim/triggers/github'
import { gmailPollingTrigger } from '@/lib/sim/triggers/gmail'
import { googleFormsWebhookTrigger } from '@/lib/sim/triggers/googleforms'
import {
...
} from '@/lib/sim/triggers/hubspot'
import { imapPollingTrigger } from '@/lib/sim/triggers/imap'
import {
...
} from '@/lib/sim/triggers/linear'
import {
  microsoftTeamsChatSubscriptionTrigger,
  microsoftTeamsWebhookTrigger,
} from '@/lib/sim/triggers/microsoftteams'
import { outlookPollingTrigger } from '@/lib/sim/triggers/outlook'
import { rssPollingTrigger } from '@/lib/sim/triggers/rss'
import { slackWebhookTrigger } from '@/lib/sim/triggers/slack'
import { stripeWebhookTrigger } from '@/lib/sim/triggers/stripe'
import { telegramWebhookTrigger } from '@/lib/sim/triggers/telegram'
import { twilioVoiceWebhookTrigger } from '@/lib/sim/triggers/twilio_voice'
import { typeformWebhookTrigger } from '@/lib/sim/triggers/typeform'
import type { TriggerRegistry } from '@/lib/sim/triggers/types'
import {
...
} from '@/lib/sim/triggers/webflow'
import { whatsappWebhookTrigger } from '@/lib/sim/triggers/whatsapp'
