import { getEffectiveBlockOutputs } from '@/apps/automations/lib/block-outputs'
import { getBlock } from '@/lib/sim/blocks/registry'
import type { BlockConfig, SubBlockConfig } from '@/lib/sim/blocks/types'
import type { BlockState, SubBlockState, WorkflowState } from '@/apps/automations/stores/workflow-types'
