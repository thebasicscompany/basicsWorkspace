/**
 * Dynamic handle topology — determines dynamic connection handles for
 * condition and router blocks.
 * Copied from Sim's lib/workflows/dynamic-handle-topology.ts
 */
