...
import { useRegisterGlobalCommands } from '@/app/workspace/[orgId]/providers/global-commands-provider'
import { useUserPermissionsContext } from '@/app/workspace/[orgId]/providers/workspace-permissions-provider'
import { createCommands } from '@/app/workspace/[orgId]/utils/commands-utils'
import {
  Copilot,
  Deploy,
  Editor,
  Toolbar,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components'
import {
  usePanelResize,
  useUsageLimits,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/hooks'
import { Variables } from '@/app/workspace/[orgId]/w/[workflowId]/components/variables/variables'
import { useAutoLayout } from '@/app/workspace/[orgId]/w/[workflowId]/hooks/use-auto-layout'
import { useCurrentWorkflow } from '@/app/workspace/[orgId]/w/[workflowId]/hooks/use-current-workflow'
import { useWorkflowExecution } from '@/app/workspace/[orgId]/w/[workflowId]/hooks/use-workflow-execution'
import { getWorkflowLockToggleIds } from '@/app/workspace/[orgId]/w/[workflowId]/utils'
import { useDeleteWorkflow, useImportWorkflow } from '@/app/workspace/[orgId]/w/hooks'
import { useCollaborativeWorkflow } from '@/hooks/use-collaborative-workflow'
import { usePermissionConfig } from '@/hooks/use-permission-config'
import { useSettingsNavigation } from '@/hooks/use-settings-navigation'
import { useChatStore } from '@/apps/automations/stores/chat/store'
import { useNotificationStore } from '@/apps/automations/stores/notifications/store'
import type { PanelTab } from '@/apps/automations/stores/panel'
import { usePanelStore, useVariablesStore as usePanelVariablesStore } from '@/apps/automations/stores/panel'
import { useVariablesStore } from '@/apps/automations/stores/variables/store'
import { getWorkflowWithValues } from '@/apps/automations/stores/workflows'
...
export const Panel = memo(function Panel() {
  ...
  const { isImporting, handleFileChange } = useImportWorkflow({ orgId })
  ...
  const handleDuplicateWorkflow = useCallback(async () => {
    ...
    try {
      ...
      if (newWorkflow) {
        router.push(`/workspace/${orgId}/w/${newWorkflow}`)
      }
    } catch (error) {
