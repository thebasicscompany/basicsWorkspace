...
import { Button, Code, getCodeEditorProps, highlight, languages } from '@/lib/core/utils/cn'
...
import { CopilotMarkdownRenderer } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/copilot-message/components/markdown-renderer'
import { SmoothStreamingText } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/copilot-message/components/smooth-streaming'
import { ThinkingBlock } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/copilot-message/components/thinking-block'
import { LoopTool } from '@/app/workspace/[orgId]/w/[workflowId]/components/subflows/loop/loop-config'
import { ParallelTool } from '@/app/workspace/[orgId]/w/[workflowId]/components/subflows/parallel/parallel-config'
import { getDisplayValue } from '@/app/workspace/[orgId]/w/[workflowId]/components/workflow-block/workflow-block'
import { getBlock } from '@/lib/sim/blocks/registry'
import type { CopilotToolCall } from '@/apps/automations/stores/panel'
import { useCopilotStore, usePanelStore } from '@/apps/automations/stores/panel'
import type { SubAgentContentBlock } from '@/apps/automations/stores/panel/copilot/types'
