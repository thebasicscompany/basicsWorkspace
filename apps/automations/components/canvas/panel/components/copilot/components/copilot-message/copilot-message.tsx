...
import { Button } from '@/lib/core/utils/cn'
import { MessageActions } from '@/app/workspace/[orgId]/components'
import {
  OptionsSelector,
  parseSpecialTags,
  ToolCall,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components'
import {
  ...
  ThinkingBlock,
  UsageLimitActions,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/copilot-message/components'
...
import {
  ...
  useMessageEditing,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/copilot-message/hooks'
import { UserInput } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/user-input'
import { buildMentionHighlightNodes } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/utils'
import type { CopilotMessage as CopilotMessageType } from '@/apps/automations/stores/panel'
import { useCopilotStore } from '@/apps/automations/stores/panel'
