 ...
 * @example
 * ```tsx
 * import { PlanModeSection } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components'
 *
...
import { Button, Textarea } from '@/lib/core/utils/cn'
