...
import type { MentionFolderNav } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/components'
import {
  DOCS_CONFIG,
  FOLDER_CONFIGS,
  type FolderConfig,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/constants'
import type { useMentionMenu } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/hooks/use-mention-menu'
import { isContextAlreadySelected } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/copilot/components/user-input/utils'
