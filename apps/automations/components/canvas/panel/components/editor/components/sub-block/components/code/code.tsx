...
import {
  checkEnvVarTrigger,
  EnvVarDropdown,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/components/sub-block/components/env-var-dropdown'
import {
  checkTagTrigger,
  TagDropdown,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/components/sub-block/components/tag-dropdown/tag-dropdown'
...
import { restoreCursorAfterInsertion } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/utils'
import { WandPromptBar } from '@/app/workspace/[orgId]/w/[workflowId]/components/wand-prompt-bar/wand-prompt-bar'
...
import type { GenerationType } from '@/lib/sim/blocks/types'
...
export const Code = memo(function Code({
  ...
  const availableEnvVars = useAvailableEnvVarKeys(orgId)
