...
import { checkEnvVarTrigger } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/components/sub-block/components/env-var-dropdown'
import { checkTagTrigger } from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/components/sub-block/components/tag-dropdown/tag-dropdown'
...
export function useSubBlockInput(options: UseSubBlockInputOptions): UseSubBlockInputResult {
  ...
  const orgId = (orgIdProp || (params?.orgId as string)) ?? undefined
