...
import { Button, Tooltip } from '@/lib/core/utils/cn'
import {
  buildCanonicalIndex,
...
import {
  ...
  SubBlock,
  SubflowEditor,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/components'
import {
  useBlockConnections,
  useConnectionsResize,
  useEditorBlockProperties,
  useEditorSubblockLayout,
} from '@/app/workspace/[orgId]/w/[workflowId]/components/panel/components/editor/hooks'
...
import { getSubBlockStableKey } from '@/app/workspace/[orgId]/w/[workflowId]/components/workflow-block/utils'
import { useCurrentWorkflow } from '@/app/workspace/[orgId]/w/[workflowId]/hooks'
import {
  isAncestorProtected,
  isBlockProtected,
} from '@/app/workspace/[orgId]/w/[workflowId]/utils/block-protection-utils'
import { PreviewWorkflow } from '@/app/workspace/[orgId]/w/components/preview'
import { getBlock } from '@/lib/sim/blocks/registry'
import type { SubBlockType } from '@/lib/sim/blocks/types'
import { useWorkflowState } from '@/hooks/queries/workflows'
import { useCollaborativeWorkflow } from '@/hooks/use-collaborative-workflow'
import { usePanelEditorStore } from '@/apps/automations/stores/panel'
...
export function Editor() {
  ...
  const handleOpenChildWorkflow = useCallback(() => {
    if (childWorkflowId && orgId) {
      window.open(`/workspace/${orgId}/w/${childWorkflowId}`, '_blank', 'noopener,noreferrer')
    }
  }, [childWorkflowId, orgId])
