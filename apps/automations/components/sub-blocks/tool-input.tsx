...
import {
  ...
  Switch,
  Tooltip,
} from '@/apps/automations/components/sub-blocks/stubs/emcn'
...
import {
  LongInput,
  ShortInput,
} from '@/apps/automations/components/sub-blocks/index'
import {
  type CustomTool,
  CustomToolModal,
} from '@/apps/automations/components/sub-blocks/tool-input/components/custom-tool-modal/custom-tool-modal'
import { ToolCredentialSelector } from '@/apps/automations/components/sub-blocks/tool-input/components/tools/credential-selector'
import { ParameterWithLabel } from '@/apps/automations/components/sub-blocks/tool-input/components/tools/parameter'
import { ToolSubBlockRenderer } from '@/apps/automations/components/sub-blocks/tool-input/components/tools/sub-block-renderer'
import type { StoredTool } from '@/apps/automations/components/sub-blocks/tool-input/types'
import {
  isCustomToolAlreadySelected,
  isMcpToolAlreadySelected,
  isWorkflowAlreadySelected,
} from '@/apps/automations/components/sub-blocks/tool-input/utils'
...
import { usePermissionConfig } from '@/hooks/stubs/use-permission-config'
