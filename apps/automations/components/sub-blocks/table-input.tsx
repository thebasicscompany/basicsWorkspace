...
import { Button } from '@/apps/automations/components/sub-blocks/stubs/emcn'
...
export function Table({
  ...
  const renderHeader = () => (
    <thead className='bg-transparent'>
      <tr className='border-[var(--color-border)] border-b bg-transparent'>
        {columns.map((column, index) => (
          <th
            key={column}
            className={cn(
              'bg-transparent px-[10px] py-[5px] text-left font-medium text-[14px] text-[var(--text-tertiary)]',
              index < columns.length - 1 && 'border-[var(--color-border)] border-r'
            )}
          >
            {column}
          </th>
    ...
    return (
      <td
        ...
        className={cn(
          ...
          cellIndex < columns.length - 1 && 'border-[var(--color-border)] border-r'
        )}
      >
        <div className='relative w-full'>
          <Input
            ...
            autoComplete='off'
            className='w-full border-0 bg-transparent px-[10px] py-[8px] font-medium text-sm text-transparent leading-[21px] caret-[var(--color-text-primary)] placeholder:text-[var(--color-text-tertiary)] focus-visible:ring-0 focus-visible:ring-offset-0'
          />
          <div
            ref={(el) => {
          ...
          >
            <div className='whitespace-pre py-[8px] font-medium text-[var(--color-text-primary)] text-sm leading-[21px]'>
        ...
        <table className='w-full bg-transparent'>
          ...
          <tbody className='bg-transparent'>
            {rows.map((row, rowIndex) => (
              <tr
                key={row.id}
                className='group relative border-[var(--color-border)] border-t bg-transparent'
              >
