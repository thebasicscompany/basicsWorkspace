...
import { splitReferenceSegment } from '@/apps/automations/lib/sanitization-references'
import { normalizeName, REFERENCE } from '@/lib/sim/executor/constants'
import { createCombinedPattern } from '@/lib/sim/executor/utils/reference-validation'
