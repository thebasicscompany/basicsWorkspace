/**
 * Selector setup hook.
 * Copied from Sim's sub-block/hooks/use-selector-setup.ts
 */
'use client'
...
import { extractEnvVarName, isEnvVarReference, isReference } from '@/lib/sim/executor/constants'
import type { SelectorContext, SelectorKey } from '@/hooks/selectors/types'
import { useEnvironmentStore } from '@/apps/automations/stores/settings'
