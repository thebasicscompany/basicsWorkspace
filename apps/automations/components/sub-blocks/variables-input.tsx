...
export function VariablesInput({
  ...
  if (!isPreview && hasNoWorkflowVariables && assignments.length === 0) {
    return <p className='text-[var(--color-text-tertiary)] text-sm'>No variables available</p>
  }
          ...
          {assignments.map((assignment, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'rounded-[4px] border border-[var(--color-border)]',
                  collapsed ? 'overflow-hidden' : 'overflow-visible'
                )}
              >
                <div
                  className='flex cursor-pointer items-center justify-between rounded-t-[4px] bg-[var(--color-bg-base)] px-[10px] py-[5px]'
                ...
                {!collapsed && (
                  <div className='flex flex-col gap-[8px] rounded-b-[4px] border-[var(--color-border)] border-t bg-[var(--surface-2)] px-[10px] pt-[6px] pb-[10px]'>
                    <div className='flex flex-col gap-[6px]'>
                      ...
                      <Combobox
                        ...
                        onChange={(value: any) => handleVariableSelect(assignment.id, value)}
                      ...
                      {assignment.type === 'boolean' ? (
                        ...
                        <div className='relative'>
                          <Textarea
                            ...
                            onDrop={(e: any) => handleDrop(e, assignment.id)}
                            onDragOver={(e: any) => handleDragOver(e, assignment.id)}
                            onDragLeave={(e: any) => handleDragLeave(e, assignment.id)}
                          />
                          <div
                            ref={(el: any) => {
