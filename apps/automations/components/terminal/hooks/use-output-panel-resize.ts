...
import { OUTPUT_PANEL_WIDTH, TERMINAL_BLOCK_COLUMN_WIDTH } from '@/apps/automations/stores/constants'
import { useTerminalStore } from '@/apps/automations/stores/terminal'
